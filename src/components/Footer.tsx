    ...
    try {
      ...
      if (response.ok) {
        ...
        if (response.status === 404) {
          throw new Error("Form not found. Please verify the Formspree form ID (mblklvdv) in the dashboard.");
        } else if (response.status === 403) {
          throw new Error("Form is not active. Please activate it by submitting from your deployed site.");
        } else {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-indigo-500/10 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-60 h-60 bg-purple-500/5 rounded-full animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-6 animate-fadeInUp">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-xl font-bold">Badda Alatunnesa</h3>
                  <p className="text-blue-200 text-sm">Higher Secondary School & College</p>
                </div>
              </div>
              <p className="text-gray-300 leading-relaxed">
                Empowering minds, shaping futures. We are committed to providing quality education and nurturing the next generation of leaders.
              </p>
            ...
            <div className="space-y-6 animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
              ...
              <ul className="space-y-4">
                {contactInfo.map((contact, index) => (
                  <li key={index} className="flex items-start space-x-3 text-gray-300 group">
                    <span className="text-lg mt-0.5 group-hover:animate-pulse">{contact.icon}</span>
            ...
            <div className="space-y-6 animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
              ...
              <form onSubmit={handleNewsletterSubmit} action="https://formspree.io/f/mblklvdv" method="POST" className="space-y-3">
                <input
                  type="email"
                  name="email"
          ...
          <div className="container mx-auto px-4 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-center md:text-left">
              <div className="text-gray-300 text-sm animate-fadeInLeft">
                © 2025 Badda Alatunnesa Higher Secondary School & College. All rights reserved. Powerded by <a href="" className="text-blue-300 hover:text-blue-400 transition-colors">Mahtaf Hossain</a>.
              </div>
